...
gen StateFIPS2=.
replace StateFIPS2=	15	if 	state=="HI"
replace StateFIPS2=	1	if 	state=="AL"
replace StateFIPS2=	2	if 	state=="AK"
replace StateFIPS2=	4	if 	state=="AZ"
replace StateFIPS2=	5	if 	state=="AR"
replace StateFIPS2=	6	if 	state=="CA"
replace StateFIPS2=	8	if 	state=="CO"
replace StateFIPS2=	9	if 	state=="CT"
replace StateFIPS2=	10	if 	state=="DE"
replace StateFIPS2=	11	if 	state=="DC"
replace StateFIPS2=	12	if 	state=="FL"
replace StateFIPS2=	13	if 	state=="GA"
replace StateFIPS2=	16	if 	state=="ID"
replace StateFIPS2=	17	if 	state=="IL"
replace StateFIPS2=	18	if 	state=="IN"
replace StateFIPS2=	19	if 	state=="IA"
replace StateFIPS2=	20	if 	state=="KS"
replace StateFIPS2=	21	if 	state=="KY"
replace StateFIPS2=	22	if 	state=="LA"
replace StateFIPS2=	23	if 	state=="ME"
replace StateFIPS2=	24	if 	state=="MD"
replace StateFIPS2=	25	if 	state=="MA"
replace StateFIPS2=	26	if 	state=="MI"
replace StateFIPS2=	27	if 	state=="MN"
replace StateFIPS2=	28	if 	state=="MS"
replace StateFIPS2=	29	if 	state=="MO"
replace StateFIPS2=	30	if 	state=="MT"
replace StateFIPS2=	31	if 	state=="NE"
replace StateFIPS2=	32	if 	state=="NV"
replace StateFIPS2=	33	if 	state=="NH"
replace StateFIPS2=	34	if 	state=="NJ"
replace StateFIPS2=	35	if 	state=="NM"
replace StateFIPS2=	36	if 	state=="NY"
replace StateFIPS2=	37	if 	state=="NC"
replace StateFIPS2=	38	if 	state=="ND"
replace StateFIPS2=	39	if 	state=="OH"
replace StateFIPS2=	40	if 	state=="OK"
replace StateFIPS2=	41	if 	state=="OR"
replace StateFIPS2=	42	if 	state=="PA"
replace StateFIPS2=	44	if 	state=="RI"
replace StateFIPS2=	45	if 	state=="SC"
replace StateFIPS2=	46	if 	state=="SD"
replace StateFIPS2=	47	if 	state=="TN"
replace StateFIPS2=	48	if 	state=="TX"
replace StateFIPS2=	49	if 	state=="UT"
replace StateFIPS2=	50	if 	state=="VT"
replace StateFIPS2=	51	if 	state=="VA"
replace StateFIPS2=	53	if 	state=="WA"
replace StateFIPS2=	54	if 	state=="WV"
replace StateFIPS2=	55	if 	state=="WI"
replace StateFIPS2=	56	if 	state=="WY"
